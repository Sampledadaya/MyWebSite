...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(template_name='blog/login.html'), name='login'),  # Вход
    path('logout/', auth_views.LogoutView.as_view(template_name='blog/logout.html'), name='logout'),  # Выход
    path('articles/new/', views.article_create, name='article_create'),  # Создание статьи
    path('articles/edit/<int:article_id>/', views.article_edit, name='article_edit'),  # Редактирование статьи
